...
word_to_label = {
    ...
    '수채화': 0, '실선': 0, '표현력': 0, '연출력': 0, '전투씬': 0, '탄탄': 0, '털선': 0, '마카': 0, '추상화': 0, '피카소': 0,
    '마커': 0, '액션씬': 0, '그리': 0, '그림': 0, '작풍': 0, '인체': 0, '곡선': 0, '인삐': 0,
    '소재': 1, '스토리': 1, '추측': 1, '내용': 1, '흥미진진': 1, '소름': 1, '재미': 1, '이해': 1, '떡밥': 1, '에피소드': 1,
    '스케일': 1, '이야기': 1, '세계관': 1, '진행': 1, '구상': 1, '빅피쳐': 1, '추리': 1, '전개': 1, '분량': 2,
    '쿠키': 3, '이모티콘': 3, '스포': 3, '정주행': 3, '휴재': 3, '디자인': 4
}
